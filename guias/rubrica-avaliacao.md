...
Estas rubricas apoiam o professor e a equipe na avaliação por evidências auditáveis do repositório.

## Rubricas de avaliação relacionadas ao estudante
...
- [x] navegação (básica)
- [x] tela sobre (básica)
- [x] transações fundamentais (básica) 
- [ ] transações complementares (intermediária)
- [ ] responsividade às telas de diferentes formatos (intermediária)
- [ ] mensagens de alerta e erro (intermediária)
- [ ] validações e máscaras de campos (intermediária) 
- [ ] capacidade de upload e leitura de arquivos locais ou em nuvem (avançada)
- [ ] exportação de dados em XLS, CSV ou JSON (avançada)
- [ ] parametrizações (avançada)
- [ ] campos customizados (avançada)
- [ ] uso da câmera do celular (avançada)
- [ ] Dashboards (avançada)
- [ ] sincronização com servidores em nuvem (avançada)
- [ ] uso do GPS, aceletrômetro, bússola (avançada)
- [ ] chamadas de APIs (avançada)
